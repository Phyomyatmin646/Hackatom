...
export default function Grid() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section - with your current working slideshow */}
      <section className="relative bg-gradient-to-br from-blue-800 via-blue-700 to-cyan-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right Slideshow - keep your current working one */}
      ...
      {/* NEW SECTION: Your Two Real Photos - Added Beautifully */}
