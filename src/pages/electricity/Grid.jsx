...
export default function Grid() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative bg-linear-to-br from-blue-800 via-blue-700 to-cyan-600 text-white">
        <div className="absolute inset-0 bg-black opacity-40"></div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36">
          <div className="grid lg:grid-cols-2 gap-16 items-start lg:min-h-[500px]">
            {/* Left Content */}
            ...
            <div className="relative h-96 lg:h-[500px]">
              <div className="w-full h-full rounded-3xl overflow-hidden shadow-2xl">
                <Slideshow
                  images={[
                    { src: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&h=600&fit=crop", title: "33/11 kV Substation", caption: "Serving 800+ Hectares" },
                    { src: "https://images.unsplash.com/photo-1509391366360-2e938m0coffe?w=800&h=600&fit=crop", title: "Smart Grid Control Room", caption: "24/7 Monitoring" },
                    { src: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&h=600&fit=crop", title: "Transformer Bay", caption: "Real-Time Load Management" },
                  ]}
                />
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={i} className="group bg-linear-to-b from-gray-50 to-white rounded-2xl p-10 border border-gray-200 hover:shadow-2xl hover:border-cyan-300 transition-all duration-300">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-linear-to-r from-blue-700 to-cyan-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
