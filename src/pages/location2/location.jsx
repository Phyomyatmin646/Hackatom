...
// ============================================
// CHIN STATE INTRO COMPONENT WITH SLIDESHOW
// ============================================
...
// Map view controller for focusing on sites
...
// Grid Simulation Panel Component
const GridSimulationPanel = ({ sites = [] }) => {
  ...
  // Chart configuration for multi-location comparison over years
...
const Location = ({ onSiteSelect, initialSites = [] }) => {
  ...
  // Handle map click - place new site
