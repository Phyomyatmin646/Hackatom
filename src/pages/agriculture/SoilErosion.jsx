  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
    ...
    <div className="max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        <Atom className="w-8 h-8 sm:w-12 sm:h-12 text-indigo-300" />
        <span className="text-indigo-300 font-bold uppercase tracking-wider text-xs sm:text-sm">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
        <a href="/contact" className="inline-flex items-center justify-center gap-3 bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-3 px-6 sm:py-4 sm:px-8 text-sm sm:text-base rounded-lg transition transform hover:scale-105 shadow-xl">
          Request Nuclear Soil Scan
        </a>
        <a href="/contact" className="inline-flex items-center justify-center border-2 border-white hover:bg-white hover:text-indigo-900 text-white font-bold py-3 px-6 sm:py-4 sm:px-8 text-sm sm:text-base rounded-lg transition">
    ...
    <div className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
            {solutions.map((item, i) => (
              <div key={i} className="group bg-linear-to-b from-gray-50 to-white rounded-2xl p-6 sm:p-8 border border-gray-200 hover:shadow-2xl hover:border-indigo-300 transition-all duration-300">
                <div className="inline-flex p-3 sm:p-4 bg-gray-100 rounded-2xl mb-4 sm:mb-6 group-hover:bg-indigo-100 transition">
      ...
      {/* Impact Metrics */}
      <section className="py-12 sm:py-16 lg:py-24 bg-linear-to-r from-indigo-800 to-purple-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
            {statistics.map((item, i) => (
              <div key={i} className="text-center">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-indigo-300 mb-2 sm:mb-4">
                  {item.metric}
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">{item.label}</h3>
                <p className="text-sm sm:text-base text-indigo-100 leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="bg-linear-to-r from-gray-50 to-white rounded-2xl p-6 sm:p-8 lg:p-10 border border-gray-200 hover:shadow-lg transition-all">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-3">
                  <span className="flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-indigo-500 text-white font-bold text-sm sm:text-base">
                    {i + 1}
                  </span>
                  {phase.phase}
                </h3>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 bg-linear-to-r from-indigo-700 to-purple-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">Stabilize Land with Nuclear Precision</h2>
          ...
          <a href="/contact" className="inline-flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-indigo-900 font-bold py-3 px-6 sm:py-4 sm:px-8 text-sm sm:text-base rounded-lg transition transform hover:scale-105 shadow-xl">
